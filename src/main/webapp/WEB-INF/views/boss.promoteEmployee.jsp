				...
				<form:form method="POST" modelAttribute="actualEmployee"
					...
					<fieldset>
						...
						<div class="form-group">
							<label class="control-label col-lg-2" for="newPosition">New
								position</label>
							<div class="col-lg-2">
						...
						<div class="form-group">
							<label class="control-label col-lg-2 col-lg-2" for="salary">New
								salary</label>
							<div class="col-lg-2">
						...
						<div class="form-group">
							<div class="col-lg-offset-2 col-lg-2">
								<a href="<spring:url value="/boss/menu"/>"
									class="btn btn-success"> <span
									class="glyphicon-chevron-left glyphicon" /></span> Cancel
								</a> <input type="submit" id="btnAdd" class="btn btn-primary"
									value="Update" />
							</div>
						</div>
