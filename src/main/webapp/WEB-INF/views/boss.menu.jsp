			...
			<div class="container">
				<p>
					<a href="<spring:url value="/logout"/>"
						class="btn btn-info pull-right"> Logout
					</a>
				</p>
				<h1>Boss Panel</h1>
			...
			<div class="col-sm-8 col-md-4" style="padding-bottom: 10px">
				<div class="thumbnail">
					<div class="caption">
						...
						<p>
							<a href="<spring:url value="/boss/displayEmployees"/>"
			...
			<div class="col-sm-8 col-md-4" style="padding-bottom: 10px">
				<div class="thumbnail">
					<div class="caption">
						...
						<p>
							<a href="<spring:url value="/boss/summary"/>"
								class="btn btn-success"> <span
								class="glyphicon-info-sign glyphicon" /></span> Display
							</a>
						</p>
					</div>
				</div>
			...
			<div class="col-sm-8 col-md-4" style="padding-bottom: 10px">
				<div class="thumbnail">
					<div class="caption">
						...
						<p>
							<a href="<spring:url value="/boss/addEmployee"/>"
								class="btn btn-success"> <span
